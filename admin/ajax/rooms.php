  ...
  while ($row = mysqli_fetch_assoc($res)) {
    ...
    $data .= "
      <tr class='align-middle'>
          ...
          <td>$status</td>
          <td>
            <button type='button' onclick='edit_details($row[id])' class='btn btn-primary shadow-none btn-sn' data-bs-toggle='modal' data-bs-target='#edit-room'>
              <i class='bi bi-pencil-square me-1'></i>
            </button>
            <button type='button' onclick=\"room_images($row[id],'$row[name]')\" class='btn btn-info shadow-none btn-sn' data-bs-toggle='modal' data-bs-target='#room-images'>
              <i class='bi bi-images me-1'></i>
            </button>
            <button type='button' onclick='remove_room($row[id])' class='btn btn-danger shadow-none btn-sn'>
