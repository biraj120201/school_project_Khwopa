        ...
        <div class="container-fluid" id="main-content">
            <div class="row">
                <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                    <h3 class="m-b-4">Features & Facilities</h3>
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <button type="button" class="btn btn-dark shadow-none btn-sn" data-bs-toggle="modal" data-bs-target="#feature-s">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-dark shadow-none btn-sn" data-bs-toggle="modal" data-bs-target="#facility-s">
                                    <i class="bi bi-plus-square me-1"></i>ADD
                                </button>
                            </div>
        ...
        <div class="modal-dialog">
            <form id="facility_s_form">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="reset" class="btn text-secondary text-dark shadow-none custom-bg" data-bs-dismiss="modal">CANCEL</button>
                        <button type="submit" class="btn text-secondary text-dark shadow-none custom-bg">SUBMIT</button>
                    </div>
                </div> <!-- Close modal-content -->
            </form>
